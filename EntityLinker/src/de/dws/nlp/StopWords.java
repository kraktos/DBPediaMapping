...
public class StopWords {
    private static String[] s_stopWords = {
            "m", "a", "about", "above", "above", "across", "after", "afterwards",
    ...
    /*
     * public String removeStopWords(String input) { String[] splits =
     * input.split("\\s"); for (String str : splits) { if
     * (stopWords.contains(str.toLowerCase())) { input = input.replace(str, "");
     * } } return input; }
     */
    ...
    public String removeStopWords(String input) {
        ...
        TokenStream tokenStream = new ClassicTokenizer(Version.LUCENE_40, new StringReader(input));
        // remove stop words
        tokenStream = new StopFilter(Version.LUCENE_40, tokenStream,
    ...
    public static void main(String[] w) {
        String input = "Without Limits was produced by Tom Cruise (Cruise and Mapother are cousins) and Paula Wagner, and released and distributed by Warner Bros. Cruise originally wanted to play the role of Prefontaine, but it was decided he was too old.";

        System.out.println(new StopWords().removeStopWords(input));
    }
};
