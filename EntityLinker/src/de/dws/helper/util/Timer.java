...
public class Timer
{
     ...
     */
	static final protected Log log = LogFactory.getLog(Timer.class);
    ...
    /** 
     * Print how long the timed operation took.
     * Milliseconds returned are measured from the initial start time.
     *
     *  @return Number of elapsed milliseconds
     */
    public long getTime() { return System.currentTimeMillis() - initialStartTime; }
    ...
    /**
     * Returns a string representation of the time passed <b>since the last {@code tick()} operation</b>.
     * This method invokes {@code tick()}, so the last ticked time will be updated. 
     * <p>
     * The returned format is the following:
     * <p>
     * HHh:MMm:SSs
     * <p>
     * Example: if 2000 milliseconds have passed, the string returned is 00h:00m:02s. 
     * @return
     */
    ...
    /**
     * Returns a string representation of the time passed <b>since the initial start time</b>.
     * <p>
     * The returned format is the following:
     * <p>
     * HHh:MMm:SSs
	 ...
	 * @param time a string representing time. This <b>must</b> be of the format
	 * <p>3h:4m:35s</p>
	 * Notes:
	 * <ul>
	 * 	<li> Colons are optional. So a date format like "6h24m49s" is also an acceptable input.
	 * 	<li> Spaces are accepted. So a date format like "6h 24m 49s" or "6h 24m49s" are also acceptable inputs.
	 * 	<li> Combinations of the above mentioned are accepted too. So a date format like "6h 24m:49s" or "6h: 24m:49s" are also acceptable inputs.
	 * </ul>
	 * @return The equivalent in milliseconds of the input string time.
	 * <p>Example:
	 * 	getTimeInMilliseconds("0h:30:20s") returns (30*60+20)*1000 = 1820000 milliseconds
	 * </p> 
	 */
	...
	/**
     * Returns a string representation which summarizes the long {@code ms} field.
     * The returned format is the following:
     * <p>
     * HHh:MMm:SSs
     * <p>
     * Example: if 2000 milliseconds are input, the string returned is 00h:00m:02s. 
     * @return
     */
