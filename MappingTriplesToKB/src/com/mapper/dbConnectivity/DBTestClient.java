...
public class DBTestClient
{
    ...
    public static void main(String[] args)
    {
        ...
        String testSubject = "coleman";
        String testPropString = "born";
        String testObject = "mise";

        logger.info("-------- PostgreSQL " + "JDBC Connection Testing ------------");

        //TODO parallelize
        DBConnection.performDBOperation(statement, resultSet, testSubject, USER_QUERY_ENTITIES);

        DBConnection.performDBOperation(statement, resultSet, testPropString, USER_QUERY_PROP);

        DBConnection.performDBOperation(statement, resultSet, testObject, USER_QUERY_ENTITIES);
